...
async def confirm_action(message: Message, state: FSMContext):
    ...
    await message.answer("Succesfully unsubscribed", reply_markup=helpers.make_row_keyboard(arr1))
    await message.answer(f"You'll be kicked at {kick_date}", reply_markup=helpers.make_row_keyboard(arr1))
